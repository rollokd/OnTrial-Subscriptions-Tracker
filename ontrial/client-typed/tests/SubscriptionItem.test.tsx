...
beforeEach(() => {
    render(<SubscriptionItem onEdit={testFn} subscription={mockSub} ></SubscriptionItem >)
    vi.clearAllMocks()
})
...
describe("SubscriptionItem testing", () => {
    ...
    it("testing date formatting", () => {
        const dateRendered = screen.getByText(`${calculateRenewalText(mockSub.billingDate)}`);
